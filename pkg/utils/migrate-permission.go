...
func MigratePermission(db *gorm.DB) error {
	permissions := []models.Permission{
		...
		// Todo permissions
		{Group: string(models.TodoGroup), Name: string(models.Create)},
		{Group: string(models.TodoGroup), Name: string(models.Read)},
		{Group: string(models.TodoGroup), Name: string(models.Update)},
		{Group: string(models.TodoGroup), Name: string(models.Delete)},
		{Group: string(models.TodoGroup), Name: string(models.List)},
		{Group: string(models.TodoGroup), Name: string(models.Me)},
	}
	...
	err := MigrateRoles(db, []RolePermission{
		...
		// User - Basic read access only
		{
			...
			Permissions: []models.Permission{
				...
				// PermissionGroup
				{Group: string(models.PermissionGroup_), Name: string(models.Me)},
				// TodoGroup
				{Group: string(models.TodoGroup), Name: string(models.Me)},
			},
		},
